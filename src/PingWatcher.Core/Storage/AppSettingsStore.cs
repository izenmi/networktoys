...
public static class AppSettingsStore
{
    public static AppSettingsDocument Load(string path, out string? error)
    {
        ...
        try
        {
            ...
            AppSettingsDocument? document = JsonSerializer.Deserialize(json, PingWatcherJsonContext.Default.AppSettingsDocument);
    ...
    public static void Save(string path, AppSettingsDocument document)
    {
        ...
        string json = JsonSerializer.Serialize(document, PingWatcherJsonContext.Default.AppSettingsDocument);
