...
public sealed class TableColumns : ObservableObject
{
    ...
    [
        ...
        // ACI ポート: 0 ノード / 1 IF / 2 状態 / 3 速度 / 4 VLAN / 5 タグ / 6 許可VLAN /
        //             7 PC / 8 EPG(星) / 9 理由 / 10 最終変化 / 11 説明
        new("aciport", 8, [(0, 60), (1, 90), (2, 80), (3, 70), (4, 110), (5, 80), (6, 140),
                           (7, 80), (9, 110), (10, 130), (11, 180)]),
