...
public sealed class TableColumns : ObservableObject
{
    ...
    [
        ...
        new("mrdhcp", 3, [(0, 130), (1, 130), (2, 60), (4, 100), (5, 70), (6, 70)]),
        ...
        // ACI ポート: 0 ノード / 1 IF / 2 管理 / 3 状態 / 4 速度 / 5 用途 / 6 PC /
        //             7 EPG(星) / 8 VLAN / 9 タグ / 10 理由 / 11 最終変化
        new("aciport", 7, [(0, 60), (1, 90), (2, 50), (3, 80), (4, 70), (5, 70), (6, 70),
                           (8, 110), (9, 80), (10, 110), (11, 130)]),
