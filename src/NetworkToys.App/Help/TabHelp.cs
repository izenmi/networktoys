...
internal static class TabHelp
{
    ...
    public const string MerakiTraffic =
        ...
        この画面ですること
        ・拠点ごとに、選んだ期間に WAN 回線を流れた通信量を並べる
        ・下段では、選んだ拠点の通信量の推移を折れ線で見る
