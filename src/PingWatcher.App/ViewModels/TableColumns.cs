...
public sealed class TableColumns : ObservableObject
{
    ...
    [
        // 経路: 0 ホップ / 1 応答元 / 2 RTT / 3 損失 / 4 備考(星)
        new("trace", 4, [(0, 46), (1, 190), (2, 76), (3, 66)]),

        // 無線: 0 SSID / 1 BSSID / 2 信号 / 3 ch / 4 規格 / 5 暗号(星)
        new("wifi", 5, [(0, 180), (1, 140), (2, 90), (3, 56), (4, 80)]),

        // スキャン: 0 IP / 1 RTT / 2 ホスト名(星) / 3 MAC / 4 ベンダー / 5 ポート
        new("scan", 2, [(0, 120), (1, 66), (3, 130), (4, 140), (5, 120)]),

        // ファイル配布の記録: 0 時刻 / 1 種別 / 2 相手 / 3 内容(星)
        new("filelog", 3, [(0, 76), (1, 70), (2, 130)]),

        // syslog: 0 時刻 / 1 送信元 / 2 重大度 / 3 本文(星)
        new("syslog", 3, [(0, 76), (1, 130), (2, 90)]),

        // SNMP GET: 0 OID / 1 名前 / 2 型 / 3 値(星)
        new("snmpget", 3, [(0, 220), (1, 130), (2, 90)]),

        // SNMP Trap: 0 時刻 / 1 送信元 / 2 OID / 3 値(星)
        new("snmptrap", 3, [(0, 76), (1, 130), (2, 200)]),
