...
public static class TargetStore
{
    ...
    public static TargetDocument Load(string path, out string? error)
    {
        ...
        try
        {
            ...
            TargetDocument? document = JsonSerializer.Deserialize(json, NetworkToysJsonContext.Default.TargetDocument);
    ...
    public static void Save(string path, TargetDocument document)
    {
        ...
        string json = JsonSerializer.Serialize(document, NetworkToysJsonContext.Default.TargetDocument);
